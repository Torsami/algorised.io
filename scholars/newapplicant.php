...
If you have a bank slip for application form, submit the Transaction code and Serial Number in-order to sign-up</p>

<form action="" method="POST" >
<p>00000-00000-00000-00000</br>
...
header ("location: signup.php");
    ...
    echo'<font color="red"> Invalid Serial or Pin Number, Please try again..</font>';	
};

}else{
	echo '<font color="red">Invalid Pin or Serial Number, Please try again..</font>';
};
